...
namespace GeometryHelper.Geometry
{
    ...
    public readonly struct GeoVector2 : IEquatable<GeoVector2>
    {
        ...
        /// <summary>
        /// Puts this vector of the plane back into space, parallel to the plane of a frame.
        /// </summary>
        /// <param name="frame">The frame it was laid out in.</param>
        /// <returns>The vector in space.</returns>
        public GeoVector3 ToVector3(GeoCoordinateSystem3 frame) => PlanarMap.ToVector3(frame, this);

        /// <summary>
        /// Determines whether this vector points the same way as another, using the default tolerance.
        /// </summary>
        /// <param name="other">The vector to compare with.</param>
        /// <returns>true if the vectors are parallel and point the same way; otherwise, false.</returns>
        public bool IsCodirectionalTo(GeoVector2 other) => Parallel2.IsCodirectional(this, other);

        /// <summary>
        /// Determines whether this vector points the same way as another, within a tolerance.
        /// </summary>
        /// <param name="other">The vector to compare with.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the vectors are parallel and point the same way; otherwise, false.</returns>
        public bool IsCodirectionalTo(GeoVector2 other, Tolerance tolerance) => Parallel2.IsCodirectional(this, other, tolerance);

        /// <summary>
        /// Applies a transformation to this vector. The translation does not touch a vector.
        /// </summary>
        /// <param name="transform">The transformation to apply.</param>
        /// <returns>The transformed vector.</returns>
        /// <exception cref="ArgumentNullException">Thrown when the transformation is null.</exception>
        public GeoVector2 TransformBy(GeoTransform2 transform)
        {
            if (transform == null)
            {
