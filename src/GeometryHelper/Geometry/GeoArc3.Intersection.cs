...
namespace GeometryHelper.Geometry
{
    ...
    public readonly partial struct GeoArc3
    {
        ...
        /// <summary>
        /// Gets every point where an edge crosses this arc.
        /// </summary>
        /// <param name="edge">The edge.</param>
        public GeoPoint3[] GetIntersections(GeoEdge3 edge) => GetIntersections(edge, Tolerance.Global);

        /// <summary>
        /// Gets every point where an edge crosses this arc, within a tolerance.
        /// </summary>
        /// <param name="edge">The edge.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Tries to find where an edge crosses this arc.
        /// </summary>
        /// <param name="edge">The edge.</param>
        /// <param name="intersections">The crossing points when the method returns true; empty otherwise.</param>
        ...
        /// <summary>
        /// Tries to find where an edge crosses this arc, within a tolerance.
        /// </summary>
        /// <param name="edge">The edge.</param>
        /// <param name="intersections">The crossing points when the method returns true; empty otherwise.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Gets every point where a curved chain crosses this arc.
        /// </summary>
        ...
        /// <summary>
        /// Gets every point where a curved chain crosses this arc, within a tolerance.
        /// </summary>
        /// <param name="chain">The curved chain.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Gets every point where a curved loop crosses this arc.
        /// </summary>
        ...
        /// <summary>
        /// Gets every point where a curved loop crosses this arc, within a tolerance.
        /// </summary>
        /// <param name="loop">The curved loop.</param>
        /// <param name="tolerance">The tolerance.</param>
