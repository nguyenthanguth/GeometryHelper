...
namespace GeometryHelper.Geometry
{
    ...
    {
        /// <summary>
        /// Checks whether this curved chain touches a plane.
        /// </summary>
        /// <param name="plane">The plane.</param>
        public bool CollidesWith(GeoPlane3 plane) => ArcChain3.CollidesWith(this, plane);

        /// <summary>
        /// Checks whether this curved chain touches a plane, within a tolerance.
        /// </summary>
        /// <param name="plane">The plane.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches a triangle.
        /// </summary>
        /// <param name="triangle">The triangle.</param>
        public bool CollidesWith(GeoTriangle3 triangle) => ArcChain3.CollidesWith(this, triangle);

        /// <summary>
        /// Checks whether this curved chain touches a triangle, within a tolerance.
        /// </summary>
        /// <param name="triangle">The triangle.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches a polygon.
        /// </summary>
        /// <param name="polygon">The polygon.</param>
        public bool CollidesWith(GeoPolygon3 polygon) => ArcChain3.CollidesWith(this, polygon);

        /// <summary>
        /// Checks whether this curved chain touches a polygon, within a tolerance.
        /// </summary>
        /// <param name="polygon">The polygon.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches a face.
        /// </summary>
        /// <param name="face">The face.</param>
        public bool CollidesWith(GeoFace3 face) => ArcChain3.CollidesWith(this, face);

        /// <summary>
        /// Checks whether this curved chain touches a face, within a tolerance.
        /// </summary>
        /// <param name="face">The face.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches an axis-aligned box.
        /// </summary>
        /// <param name="box">The axis-aligned box.</param>
        public bool CollidesWith(GeoAabb3 box) => ArcChain3.CollidesWith(this, box);

        /// <summary>
        /// Checks whether this curved chain touches an axis-aligned box, within a tolerance.
        /// </summary>
        /// <param name="box">The axis-aligned box.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches an oriented box.
        /// </summary>
        /// <param name="box">The oriented box.</param>
        public bool CollidesWith(GeoObb3 box) => ArcChain3.CollidesWith(this, box);

        /// <summary>
        /// Checks whether this curved chain touches an oriented box, within a tolerance.
        /// </summary>
        /// <param name="box">The oriented box.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches a solid.
        /// </summary>
        /// <param name="solid">The solid.</param>
        public bool CollidesWith(GeoSolid3 solid) => ArcChain3.CollidesWith(this, solid);

        /// <summary>
        /// Checks whether this curved chain touches a solid, within a tolerance.
        /// </summary>
        /// <param name="solid">The solid.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches an arc.
        /// </summary>
        /// <param name="arc">The arc.</param>
        public bool CollidesWith(GeoArc3 arc) => ArcChain3.CollidesWith(this, arc);

        /// <summary>
        /// Checks whether this curved chain touches an arc, within a tolerance.
        /// </summary>
        /// <param name="arc">The arc.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Checks whether this curved chain touches a circle.
        /// </summary>
        /// <param name="circle">The circle.</param>
        public bool CollidesWith(GeoCircle3 circle) => ArcChain3.CollidesWith(this, circle);

        /// <summary>
        /// Checks whether this curved chain touches a circle, within a tolerance.
        /// </summary>
        /// <param name="circle">The circle.</param>
        /// <param name="tolerance">The tolerance.</param>
