...
namespace GeometryHelper.Geometry
{
    ...
    public readonly struct GeoCircle3 : IEquatable<GeoCircle3>
    {
        ...
        /// <summary>
        /// Grows this circle within its plane by a distance, or shrinks it when the distance is negative, using
        ...
        public bool TryOffset(double distance, out GeoCircle3 result) => Offset3.TryOffset(this, distance, out result);

        /// <summary>
        /// Grows this circle within its plane by a distance, or shrinks it when the distance is negative, within a
        /// tolerance.
        /// </summary>
        /// <param name="distance">How far the circumference moves: outward when positive.</param>
        /// <param name="result">The concentric circle, or this circle when the method returns false.</param>
        ...
        /// </remarks>
        public GeoPolygon3 ToPolygon() => ToPolygonByChordTolerance(0.0);
        ...
        public GeoPolygon3 ToPolygonByChordTolerance(double chordTolerance)
        {
        ...
        public GeoPolygon3 ToPolygonBySpacing(double spacing)
        {
        ...
        /// </summary>
        /// <returns>A chain all the way round, its first point repeated at the end.</returns>
        /// <remarks>
        /// A chain is always open, so the first point is repeated at the end to close the loop: that is what
        /// it takes for a <see cref="GeoPolyline3"/> to trace something closed.
        /// </remarks>
