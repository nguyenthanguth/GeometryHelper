...
namespace GeometryHelper.Geometry
{
    ...
    public sealed partial class GeoPolyline3 : IEquatable<GeoPolyline3>
    {
        ...
        /// </summary>
        /// <remarks>A chamfer needs no plane: it moves back along one leg and forward along the other, so both points land on the legs themselves and the answer is exact wherever the chain goes.</remarks>
        public GeoPolyline3 Chamfer(double distance) => Corner3.Chamfer(this, distance);

        /// <summary>
        /// Cuts every corner of the chain back by the same distance, within a tolerance.
        /// </summary>
        public GeoPolyline3 Chamfer(double distance, Tolerance tolerance) => Corner3.Chamfer(this, distance, tolerance);

        /// <summary>
        /// Cuts every corner of the chain back, by one distance along the way in and another along the way out.
        /// </summary>
        public GeoPolyline3 Chamfer(double distance1, double distance2) => Corner3.Chamfer(this, distance1, distance2);

        /// <summary>
        /// Cuts every corner of the chain back, by one distance along the way in and another along the way out,
        /// within a tolerance.
        /// </summary>
        public GeoPolyline3 Chamfer(double distance1, double distance2, Tolerance tolerance)
        ...
        /// </summary>
        public bool TryChamferAt(int index, double distance1, double distance2, out GeoPolyline3 result)
        ...
        /// </summary>
        public bool TryChamferAt(int index, double distance1, double distance2, out GeoPolyline3 result, Tolerance tolerance)
        ...
        /// <summary>
        /// Says where a point lies with respect to this chain.
        /// </summary>
        /// <remarks>
        /// An open chain encloses nothing, even where its two ends happen to meet. There is no inside, so the answer is only ever <c>OnSide</c> or <c>OutSide</c>; it is
        ...
        /// <summary>
        /// Says where a point lies with respect to this chain, within a tolerance.
        /// </summary>
        /// <param name="point">The point.</param>
        /// <param name="tolerance">The tolerance that decides what counts as on it.</param>
        /// <returns><c>OnSide</c> when the point is on the chain; otherwise, <c>OutSide</c>.</returns>
