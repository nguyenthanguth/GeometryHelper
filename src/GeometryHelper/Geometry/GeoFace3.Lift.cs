...
{
    /// <summary>
    /// What a face in space can answer by working in its own plane: combining it with another flat shape lying in that same plane.
    /// </summary>
    /// <remarks>
    ...
    public sealed partial class GeoFace3
    {
        ...
        /// <summary>
        /// Determines whether a plane is the plane this face lies in.
        /// </summary>
        public bool SharesPlaneWith(GeoPlane3 other) => SharesPlaneWith(other, Tolerance.Global);

        /// <summary>
        /// Determines whether a plane is the plane this face lies in, within a tolerance.
        /// </summary>
        ...
        /// <summary>
        /// Joins this face to a face, within a tolerance.
        /// </summary>
        /// <param name="other">The face; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        ...
        /// <summary>
        /// Joins this face to a polygon.
        /// </summary>
        public GeoFace3[] Union(GeoPolygon3 other) => Union(other, Tolerance.Global);

        /// <summary>
        /// Joins this face to a polygon, within a tolerance.
        /// </summary>
        /// <param name="other">The polygon; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
        ...
        /// <summary>
        /// Keeps what this face and a face both cover.
        /// </summary>
        public GeoFace3[] Intersect(GeoFace3 other) => Intersect(other, Tolerance.Global);

        /// <summary>
        /// Keeps what this face and a face both cover, within a tolerance.
        /// </summary>
        /// <param name="other">The face; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
        ...
        /// <summary>
        /// Keeps what this face and a polygon both cover.
        /// </summary>
        public GeoFace3[] Intersect(GeoPolygon3 other) => Intersect(other, Tolerance.Global);

        /// <summary>
        /// Keeps what this face and a polygon both cover, within a tolerance.
        /// </summary>
        /// <param name="other">The polygon; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
        ...
        /// <summary>
        /// Takes a face out of this face.
        /// </summary>
        public GeoFace3[] Subtract(GeoFace3 tool) => Subtract(tool, Tolerance.Global);

        /// <summary>
        /// Takes a face out of this face, within a tolerance.
        /// </summary>
        /// <param name="tool">The face; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
        /// <exception cref="ArgumentNullException">Thrown when the face is null.</exception>
        /// <exception cref="ArgumentException">Thrown when it lies in another plane.</exception>
        ...
        /// <summary>
        /// Takes a polygon out of this face.
        /// </summary>
        public GeoFace3[] Subtract(GeoPolygon3 tool) => Subtract(tool, Tolerance.Global);

        /// <summary>
        /// Takes a polygon out of this face, within a tolerance.
        /// </summary>
        /// <param name="tool">The polygon; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
        /// <exception cref="ArgumentNullException">Thrown when the polygon is null.</exception>
        /// <exception cref="ArgumentException">Thrown when it lies in another plane.</exception>
        ...
        /// <summary>
        /// Keeps what this face and a face cover between them but do not share.
        /// </summary>
        public GeoFace3[] Xor(GeoFace3 other) => Xor(other, Tolerance.Global);

        /// <summary>
        /// Keeps what this face and a face cover between them but do not share, within a tolerance.
        /// </summary>
        /// <param name="other">The face; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
        ...
        /// <summary>
        /// Keeps what this face and a polygon cover between them but do not share.
        /// </summary>
        public GeoFace3[] Xor(GeoPolygon3 other) => Xor(other, Tolerance.Global);

        /// <summary>
        /// Keeps what this face and a polygon cover between them but do not share, within a tolerance.
        /// </summary>
        /// <param name="other">The polygon; it has to lie in this face's plane.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>The pieces the two make, in the plane they share.</returns>
