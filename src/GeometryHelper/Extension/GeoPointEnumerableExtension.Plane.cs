...
namespace GeometryHelper.Extension
{
    ...
    /// </summary>
    public static partial class GeoPointEnumerableExtension
    {
        /// <summary>
        ...
        /// <see cref="RemoveConsecutiveNearPoints(System.Collections.Generic.List{GeometryHelper.Geometry.GeoPoint2}, GeometryHelper.Tolerance)"/> first when that matters.
        /// </para>
        /// </summary>
