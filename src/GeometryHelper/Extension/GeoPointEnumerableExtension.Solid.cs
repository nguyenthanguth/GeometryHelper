...
namespace GeometryHelper.Extension
{
    ...
    public static partial class GeoPointEnumerableExtension
    {
        ...
        /// <see cref="RemoveConsecutiveNearPoints(System.Collections.Generic.List{GeometryHelper.Geometry.GeoPoint3}, GeometryHelper.Tolerance)"/> first when that matters.
        /// </para>
        /// </summary>
