...
namespace GeometryHelper.Core
{
    ...
    public static class Parallel2
    {
        ...
        /// <summary>
        /// Determines whether two vectors point the same way, using the default tolerance.
        /// </summary>
        /// <param name="v1">The first vector.</param>
        /// <param name="v2">The second vector.</param>
        /// <returns>true if the vectors are parallel and point the same way; otherwise, false.</returns>
        public static bool IsCodirectional(GeoVector2 v1, GeoVector2 v2) => IsCodirectional(v1, v2, Tolerance.Global);

        /// <summary>
        /// Determines whether two vectors point the same way, within a tolerance.
        /// </summary>
        /// <param name="v1">The first vector.</param>
        /// <param name="v2">The second vector.</param>
        /// <param name="tolerance">The tolerance.</param>
        /// <returns>true if the vectors are parallel and point the same way; otherwise, false.</returns>
        /// <remarks>
        /// Parallel is not enough: two vectors along one line point either the same way or opposite ways, and
        /// this tells those apart. A vector with no length is neither, as it has no direction to compare.
        /// </remarks>
        public static bool IsCodirectional(GeoVector2 v1, GeoVector2 v2, Tolerance tolerance)
        {
            return IsParallel(v1, v2, tolerance) && v1.DotProduct(v2) > 0.0;
        }
    }
}
