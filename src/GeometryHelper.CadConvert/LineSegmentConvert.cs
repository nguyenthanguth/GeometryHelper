...
namespace GeometryHelper.CadConvert
{
    ...
    {
        /// <summary>
        /// Converts a AutoCAD 2D line segment to a GeometryHelper 2D line.
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 2D line segments to a list of GeometryHelper 2D lines.
        /// </summary>
        ...
        /// <summary>
        /// Converts a AutoCAD 3D line segment to a GeometryHelper 2D line (discarding the Z coordinate).
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 3D line segments to a list of GeometryHelper 2D lines (discarding their Z coordinates).
        /// </summary>
        ...
        /// <summary>
        /// Converts a AutoCAD Database Line entity to a GeometryHelper 2D line (discarding the Z coordinate).
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD Line entities to a list of GeometryHelper 2D lines.
        /// </summary>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D line to a AutoCAD Database Line entity (with Z = 0).
        /// </summary>
        /// <param name="geoLine">The GeometryHelper 2D line to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D lines to a list of AutoCAD Line entities.
        /// </summary>
        /// <param name="lines">The sequence of GeometryHelper 2D lines to convert.</param>
