...
namespace GeometryHelper.CadConvert
{
    ...
    {
        /// <summary>
        /// Converts a AutoCAD 2D point to a GeometryHelper 2D point.
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 2D points to a list of GeometryHelper 2D points.
        /// </summary>
        ...
        /// <summary>
        /// Converts a AutoCAD 3D point to a GeometryHelper 2D point (discarding the Z coordinate).
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 3D points to a list of GeometryHelper 2D points (discarding their Z coordinates).
        /// </summary>
        ...
        /// <summary>
        /// Converts a AutoCAD 3D point to a GeometryHelper 3D point.
        /// </summary>
        /// <param name="point">The AutoCAD 3D point to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 3D points to a list of GeometryHelper 3D points.
        /// </summary>
        /// <param name="points">The sequence of AutoCAD 3D points to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D point to a AutoCAD 2D point.
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D points to a list of AutoCAD 2D points.
        /// </summary>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D point to a AutoCAD 3D point (with Z = 0).
        /// </summary>
        /// <param name="point">The GeometryHelper 2D point to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D points to a list of AutoCAD 3D points (with Z = 0).
        /// </summary>
        /// <param name="points">The sequence of GeometryHelper 2D points to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 3D point to a AutoCAD 3D point.
        /// </summary>
        /// <param name="point">The GeometryHelper 3D point to convert.</param>
        /// <returns>The converted AutoCAD <see cref="Point3d"/>.</returns>
        public static Point3d ToAcadPoint3(this GeoPoint3 point) => new Point3d(point.X, point.Y, point.Z);

        /// <summary>
        /// Converts a sequence of GeometryHelper 3D points to a list of AutoCAD 3D points.
        /// </summary>
        /// <param name="points">The sequence of GeometryHelper 3D points to convert.</param>
        /// <returns>A list of converted AutoCAD <see cref="Point3d"/>.</returns>
