...
namespace GeometryHelper.CadConvert
{
    ...
    {
        /// <summary>
        /// Converts a AutoCAD 2D vector to a GeometryHelper 2D vector.
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 2D vectors to a list of GeometryHelper 2D vectors.
        /// </summary>
        ...
        /// <summary>
        /// Converts a AutoCAD 3D vector to a GeometryHelper 2D vector (discarding the Z coordinate).
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 3D vectors to a list of GeometryHelper 2D vectors (discarding their Z coordinates).
        /// </summary>
        ...
        /// <summary>
        /// Converts a AutoCAD 3D vector to a GeometryHelper 3D vector.
        /// </summary>
        /// <param name="vector">The AutoCAD 3D vector to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of AutoCAD 3D vectors to a list of GeometryHelper 3D vectors.
        /// </summary>
        /// <param name="vectors">The sequence of AutoCAD 3D vectors to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D vector to a AutoCAD 2D vector.
        /// </summary>
        /// <param name="vector">The GeometryHelper 2D vector to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D vectors to a list of AutoCAD 2D vectors.
        /// </summary>
        /// <param name="vectors">The sequence of GeometryHelper 2D vectors to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D vector to a AutoCAD 3D vector (with Z = 0).
        /// </summary>
        /// <param name="vector">The GeometryHelper 2D vector to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D vectors to a list of AutoCAD 3D vectors (with Z = 0).
        /// </summary>
        /// <param name="vectors">The sequence of GeometryHelper 2D vectors to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 3D vector to a AutoCAD 3D vector.
        /// </summary>
        /// <param name="vector">The GeometryHelper 3D vector to convert.</param>
        /// <returns>The converted AutoCAD <see cref="Vector3d"/>.</returns>
        public static Vector3d ToAcadVector3(this GeoVector3 vector) => new Vector3d(vector.X, vector.Y, vector.Z);

        /// <summary>
        /// Converts a sequence of GeometryHelper 3D vectors to a list of AutoCAD 3D vectors.
        /// </summary>
        /// <param name="vectors">The sequence of GeometryHelper 3D vectors to convert.</param>
        /// <returns>A list of converted AutoCAD <see cref="Vector3d"/>.</returns>
