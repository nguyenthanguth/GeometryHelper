...
namespace GeometryHelper.TeklaConvert
{
    ...
    {
        /// <summary>
        /// Converts a Tekla vector to a GeometryHelper 2D vector (discarding the Z coordinate).
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of Tekla vectors to a list of GeometryHelper 2D vectors (discarding their Z coordinates).
        /// </summary>
        ...
        /// <summary>
        /// Converts a Tekla vector to a GeometryHelper vector.
        /// </summary>
        /// <param name="vector">The Tekla vector to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of Tekla vectors to a list of GeometryHelper vectors.
        /// </summary>
        /// <param name="vectors">The sequence of Tekla vectors to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D vector to a Tekla vector (with Z = 0).
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D vectors to a list of Tekla vectors (with Z = 0).
        /// </summary>
        ...
        /// <summary>
        /// Converts a GeometryHelper vector to a Tekla vector.
        /// </summary>
        /// <param name="vector">The GeometryHelper vector to convert.</param>
        /// <returns>The converted Tekla <see cref="TSG.Vector"/>.</returns>
        public static TSG.Vector ToTeklaVector(this GeoVector3 vector) => new TSG.Vector(vector.X, vector.Y, vector.Z);

        /// <summary>
        /// Converts a sequence of GeometryHelper vectors to a list of Tekla vectors.
        /// </summary>
        /// <param name="vectors">The sequence of GeometryHelper vectors to convert.</param>
        /// <returns>A list of converted Tekla <see cref="TSG.Vector"/>.</returns>
