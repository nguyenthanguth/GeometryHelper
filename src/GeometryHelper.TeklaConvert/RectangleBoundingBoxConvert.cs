...
{
    /// <summary>
    /// Provides extension methods to convert bounding boxes between Tekla Drawing API and GeometryHelper.
    /// </summary>
    public static class RectangleBoundingBoxConvert
    {
        /// <summary>
        /// Converts a Tekla drawing bounding box to a GeometryHelper 2D rectangle.
        /// </summary>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D rectangle to a Tekla drawing bounding box.
        /// </summary>
        /// <param name="boundingBox">The GeometryHelper 2D rectangle to convert.</param>
