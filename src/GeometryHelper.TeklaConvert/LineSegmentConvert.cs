...
{
    /// <summary>
    /// Provides extension methods to convert line segments between Tekla Structures and GeometryHelper.
    /// </summary>
    public static class LineSegmentConvert
    {
        /// <summary>
        /// Converts a Tekla line segment to a GeometryHelper 2D line segment.
        /// </summary>
        ...
        /// <summary>
        /// Converts a Tekla line segment to a GeometryHelper line segment.
        /// </summary>
        /// <param name="segment">The Tekla line segment to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper line segment to a Tekla line segment.
        /// </summary>
        /// <param name="line">The GeometryHelper line segment to convert.</param>
        ...
        /// <summary>
        /// Converts a GeometryHelper 2D line segment to a Tekla line segment (with Z = 0).
        /// </summary>
        /// <param name="line">The GeometryHelper 2D line segment to convert.</param>
        /// <returns>The converted Tekla <see cref="TSG.LineSegment"/>.</returns>
        ...
        /// <summary>
        /// Converts a sequence of Tekla line segments to a list of GeometryHelper line segments.
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of Tekla line segments to a list of GeometryHelper 2D line segments.
        /// </summary>
        /// <param name="segments">The sequence of Tekla line segments to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper line segments to a list of Tekla line segments.
        /// </summary>
        /// <param name="lines">The sequence of GeometryHelper line segments to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper 2D line segments to a list of Tekla line segments.
        /// </summary>
        /// <param name="lines">The sequence of GeometryHelper 2D line segments to convert.</param>
        /// <returns>A list of converted Tekla <see cref="TSG.LineSegment"/>.</returns>
