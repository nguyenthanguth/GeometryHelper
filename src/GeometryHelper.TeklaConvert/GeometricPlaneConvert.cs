...
{
    /// <summary>
    /// Provides extension methods to convert geometric planes between Tekla Structures and GeometryHelper.
    /// </summary>
    public static class GeometricPlaneConvert
    {
        /// <summary>
        /// Converts a Tekla geometric plane to a GeometryHelper plane.
        /// </summary>
        ...
        /// <summary>
        /// Converts a GeometryHelper plane to a Tekla geometric plane.
        /// </summary>
        /// <param name="plane">The GeometryHelper plane to convert.</param>
