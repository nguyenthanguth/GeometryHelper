...
namespace GeometryHelper.TeklaConvert
{
    ...
    public static class GeometryDraw
    {
        ...
        /// <summary>
        /// Draws an arc as a control polycurve.
        /// </summary>
        /// <param name="arc">The arc, in the current work plane.</param>
        /// <param name="color">The colour of the polycurve.</param>
        /// <param name="lineType">The line type of the polycurve.</param>
        /// <returns>The inserted polycurve, or null when there was nothing to draw or Tekla did not insert it.</returns>
        /// <remarks>
        /// The arc is drawn as the straight pieces <see cref="GeoArc3.ToPolyline()"/> gives, within the automatic
        /// share of its radius, which is finer than a model view resolves. Pass a tessellated polyline yourself when
        /// the drawing has to be coarser or finer than that.
        /// </remarks>
            ...
            ControlObjectLineType lineType = ControlObjectLineType.SolidLine)
        {
            ...
            return DrawPolyline(arc.ToPolyline().Vertices, false, color, lineType);
        }

        /// <summary>
        /// Draws a circle as a closed control polycurve.
        /// </summary>
        /// <param name="circle">The circle, in the current work plane.</param>
        /// <param name="color">The colour of the polycurve.</param>
        /// <param name="lineType">The line type of the polycurve.</param>
        /// <returns>The inserted polycurve, or null when there was nothing to draw or Tekla did not insert it.</returns>
        /// <remarks>
        /// The circle is drawn as the straight pieces <see cref="GeoCircle3.ToPolygon()"/> gives, about fifty of
        /// them, which is finer than a model view resolves.
        /// </remarks>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="circle"/> is null.</exception>
        public static ControlPolycurve DrawToTekla(
            this GeoCircle3 circle,
            ControlObjectColorEnum color = ControlObjectColorEnum.RED,
            ControlObjectLineType lineType = ControlObjectLineType.SolidLine)
        {
            if (circle == null)
            ...
            return DrawPolyline(circle.ToPolygon().Vertices, true, color, lineType);
        }
