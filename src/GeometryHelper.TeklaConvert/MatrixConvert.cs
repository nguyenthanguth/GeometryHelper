...
{
    /// <summary>
    /// Provides extension methods to convert transformation matrices between Tekla Structures and GeometryHelper.
    /// </summary>
    public static class MatrixConvert
    {
        /// <summary>
        /// Converts a Tekla transformation matrix to a GeometryHelper transformation.
        /// </summary>
        ...
        /// right for row vectors. GeometryHelper stores a full four by four applied on the left for column
        ...
        /// <summary>
        /// Converts a GeometryHelper transformation to a Tekla transformation matrix.
        /// </summary>
        /// <param name="transform">The GeometryHelper transformation to convert.</param>
