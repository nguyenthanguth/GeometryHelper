...
{
    /// <summary>
    /// Provides extension methods to convert coordinate systems between Tekla Structures and GeometryHelper.
    /// </summary>
    public static class CoordinateSystemConvert
    {
        /// <summary>
        /// Converts a Tekla coordinate system to a GeometryHelper coordinate system.
        /// </summary>
        ...
        /// </exception>
        /// <remarks>
        /// Tekla stores two axes and leaves the third implied; GeometryHelper stores three and keeps them
        ...
        /// <summary>
        /// Converts a GeometryHelper coordinate system to a Tekla coordinate system.
        /// </summary>
        /// <param name="system">The GeometryHelper coordinate system to convert.</param>
