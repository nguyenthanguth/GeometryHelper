...
{
    /// <summary>
    /// Provides extension methods to convert bounding boxes (AABB) between Tekla Structures and GeometryHelper.
    /// </summary>
    public static class AabbConvert
    {
        /// <summary>
        /// Converts a Tekla bounding box to a GeometryHelper bounding box.
        /// </summary>
        ...
        /// <summary>
        /// Converts a GeometryHelper bounding box to a Tekla bounding box.
        /// </summary>
        /// <param name="box">The GeometryHelper bounding box to convert.</param>
        ...
        /// <summary>
        /// Converts a sequence of Tekla bounding boxes to a list of GeometryHelper bounding boxes.
        /// </summary>
        ...
        /// <summary>
        /// Converts a sequence of GeometryHelper bounding boxes to a list of Tekla bounding boxes.
        /// </summary>
        /// <param name="boxes">The sequence of GeometryHelper bounding boxes to convert.</param>
