...
namespace SolidGeometry.Core
{
    ...
    /// the resulting vector points along the polygon normal with a length of twice the area. It is also
    ...
    {
        /// <summary>
        /// Gets twice the signed area of a closed loop as a vector normal to it.
        /// </summary>
        /// <param name="vertices">
        ...
        /// </param>
        /// <returns>
        /// A vector along the loop normal whose length is twice the area, or the zero vector when the
        /// loop has fewer than three vertices or encloses nothing.
        /// </returns>
