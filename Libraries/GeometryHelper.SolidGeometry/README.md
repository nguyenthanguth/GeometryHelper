...
```
dotnet add package GeometryHelper.SolidGeometry
```
...
The last three come from the [GeometryHelper.CommonGeometry](https://www.nuget.org/packages/GeometryHelper.CommonGeometry/) package,
which [GeometryHelper.PlaneGeometry](https://www.nuget.org/packages/GeometryHelper.PlaneGeometry/) shares, so a program working in
