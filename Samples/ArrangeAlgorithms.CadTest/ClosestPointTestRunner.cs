...
namespace ArrangeAlgorithms.CadTest
{
    public class ClosestPointTestRunner
    {
        public void RunClosestPointTest()
        {
            ...
            GeoPoint2 pickedGeoPoint = pickedPoint3d.ToGeoPoint();
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                try
                {
                    ...
                    {
                        if (polyline.TryToGeoRectangle(out GeoRectangle2 geoRectangle))
                        {
                        ...
                        else if (polyline.Closed)
                        {
                            ...
                            GeoPolygon2 geoPolygon = polyline.ToGeoPolygon();
