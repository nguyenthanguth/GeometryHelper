...
// AutoCAD ships its own Autodesk.AutoCAD.Geometry.Tolerance, and this file imports both namespaces, so the
// two tie. The one meant here is named outright.
