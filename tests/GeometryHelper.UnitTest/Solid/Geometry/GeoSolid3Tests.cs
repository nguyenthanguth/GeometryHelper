...
namespace GeometryHelper.UnitTest.Solid
{
    ...
    public class GeoSolid3Tests
    {
        ...
        public void OverlappingSolidsCollideAndSeparatedOnesDoNot()
        {
            ...
            Assert.True(GeometryHelper.Core.Collision3.CollidesWith(
                first, MakeBoxSolid(new GeoPoint3(5.0, 5.0, 5.0), new GeoPoint3(15.0, 15.0, 15.0))));

            Assert.False(GeometryHelper.Core.Collision3.CollidesWith(
        ...
        public void ASolidWhollyInsideAnotherCollidesWithItEvenWithoutSurfaceContact()
        {
            ...
            Assert.True(GeometryHelper.Core.Collision3.CollidesWith(outer, inner));
            Assert.True(GeometryHelper.Core.Collision3.CollidesWith(inner, outer));
        }
