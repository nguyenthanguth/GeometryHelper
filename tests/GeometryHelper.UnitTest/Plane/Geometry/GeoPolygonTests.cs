...
namespace GeometryHelper.UnitTest.Plane
{
    public class PolygonTests
    {
        ...
        public void Polygon_WindingAndArea_WorkCorrectly()
        {
            ...
            Assert.Equal(6.0, poly.Area, 12);
            Assert.Equal(6.0, poly.SignedArea, 12);
            Assert.False(poly.IsClockwise);
            Assert.Equal(12.0, poly.Length, 9);

            // Clockwise triangle (CW)
            var polyCW = new GeoPolygon2(p1, p3, p2);
            Assert.Equal(6.0, polyCW.Area, 12);
            Assert.Equal(-6.0, polyCW.SignedArea, 12);
        ...
        public void Polygon_Centroid_WorksCorrectly()
        {
            ...
            Assert.True(poly.Centroid.IsEqualTo(new GeoPoint2(2.0, 2.0)));
        }
        ...
        public void Polygon_CentroidConcavePolygon_WorksCorrectly()
        {
            ...
            // Area = 12
            Assert.Equal(12.0, poly.Area, 12);
            ...
            Assert.True(poly.Centroid.IsEqualTo(new GeoPoint2(5.0 / 3.0, 5.0 / 3.0)));
        }
        ...
        public void Polygon_ZeroAreaCollinear_ReturnsCorrectArea()
        {
            ...
            Assert.Equal(0.0, poly.Area, 12);
            Assert.Equal(0.0, poly.SignedArea, 12);
        }
        ...
        public void Polygon_ClockwiseAndCounterClockwise_BehaveIdenticallyForContainment()
        {
            ...
            Assert.Equal(ccw.Area, cw.Area, 12);
        ...
        public void Polygon_TranslateAndRotate_ProduceMovedCopies()
        {
            ...
            Assert.Equal(poly.Area, moved.Area, 9);
            ...
            Assert.Equal(poly.Area, rotated.Area, 9);
        }
